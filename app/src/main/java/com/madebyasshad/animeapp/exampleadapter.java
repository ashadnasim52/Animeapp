...
public class exampleadapter extends RecyclerView.Adapter<exampleadapter.exampleviewholder> {
    ...
    public exampleadapter(Context mcontext, ArrayList<exampleitem> arrayList) {
    ...
    public class exampleviewholder extends RecyclerView.ViewHolder{
        ...
        public exampleviewholder(View itemView) {
            super(itemView);
            mimageview=itemView.findViewById(R.id.imagebro);
            mTextviewcreator=itemView.findViewById(R.id.text_view_creater);
